...
public class BookStoreServerUnary {
    private static final Logger logger = Logger.getLogger(BookStoreServerUnary.class.getName());
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        final BookStoreServerUnary greetServer = new BookStoreServerUnary();
        greetServer.start();
